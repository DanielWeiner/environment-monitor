...
static const AT_TokenHandler tokenHandlers[] = {
	{&readyTokenMatcher, on_ready},
};

static void on_ready(void *) {
	esp8266ATHandle.ready = true;
...
void MX_USART1_UART_Init(void) {
	...
	at_set_tokens(&esp8266ATHandle, tokenHandlers);
...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart) {
	at_buffer_rx_byte(huart, &esp8266ATHandle);
}

void HAL_UART_TxCpltCallback(UART_HandleTypeDef *huart) {
	at_tx_complete(huart, &esp8266ATHandle);
}
